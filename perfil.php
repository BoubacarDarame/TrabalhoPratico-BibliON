                ...
                <div class="profile-header text-white">
                    ...
                    <?php if (isset($_GET['erro'])): ?>
                        <div class="alert alert-danger py-2 mb-3 border-0">
                            ...
                            <?php 
                                if ($_GET['erro'] == 'match') echo "As novas passwords não coincidem.";
                                elseif ($_GET['erro'] == 'wrong') echo "A password atual está incorreta.";
                                else echo "Erro ao atualizar password.";
                            ?>
                        </div>
                    <?php endif; ?>
                    ...
                    <?php if (isset($_GET['msg']) && $_GET['msg'] == 'success'): ?>
                        <div class="alert alert-success py-2 mb-3 border-0">
                            <i class="bi bi-check-circle me-2"></i>Password atualizada com sucesso!
                        </div>
                    <?php endif; ?>
