...
-- A despejar dados para tabela biblion.problemas: ~0 rows (aproximadamente)
...
-- A despejar dados para tabela biblion.utilizadores: ~1 rows (aproximadamente)
REPLACE INTO `utilizadores` (`ID_Utilizador`, `Nome`, `Email`, `Password`, `DataRegisto`) VALUES
	(1, 'Buba', 'buba@gmail.com', '$2y$10$yC0NOpc1xkB7zekIqL9O.OzAPppY7V/FVJp96z/tvjM423IdL8RXa', '2025-12-11 14:23:36');
