            ...
            <div class="row g-4 row-cols-1 row-cols-md-2 row-cols-lg-4">
                ...
                <div class="col">
                    <div class="card h-100 shadow-sm border-0">
                        ...
                        <a href="detalhes_livro.php?id=123" aria-label="Ver detalhes de A Criada">
                        ...
                        <div class="card-body">
                            ...
                            <h5 class="card-title">
                                <a href="detalhes_livro.php?id=123" class="text-dark text-decoration-none">
                                    A Criada
                                </a>
                            </h5>
                ...
                <div class="col">
                    <div class="card h-100 shadow-sm border-0">
                        ...
                        <a href="detalhes_livro.php?id=123" aria-label="Ver detalhes de O Segredo dos Segredos">
                ...
                <div class="col">
                    <div class="card h-100 shadow-sm border-0">
                        ...
                        <a href="detalhes_livro.php?id=123" aria-label="Ver detalhes de O Protocolo Caos">
                ...
                <div class="col">
                    <div class="card h-100 shadow-sm border-0">
                        ...
                        <a href="detalhes_livro.php?id=123" aria-label="Ver detalhes de A Biblioteca da Meia-Noite">
