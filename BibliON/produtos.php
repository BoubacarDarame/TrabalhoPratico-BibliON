...
<body>
    ...
    <section class="products-section py-5">
        <div class="container">
            ...
            <div class="row g-4 row-cols-1 row-cols-md-2 row-cols-lg-4">
                ...
                <div class="col">
                    <div class="card h-100 shadow-sm border-0">
                        <img src="imgs\imagens/Biblioteca da Meia-Noite.jpg" class="card-img-top" alt="Capa do livro O Protocolo Caos">
                        <div class="card-body">
    ...
    <section class="products-section py-5">
        <div class="container">
            ...
            <div class="row mb-4">
                <div class="col-12">
                    <h2 class="display-5 fw-bold text-center">Todos os livros</h2>
                    <hr>
                </div>
            </div>
            ...
            <div class="row g-4 row-cols-1 row-cols-md-2 row-cols-lg-4">
                ...
                <div class="col">
                    <div class="card h-100 shadow-sm border-0">
                        <img src="imgs\imagens/Biblioteca da Meia-Noite.jpg" class="card-img-top" alt="Capa do livro A Biblioteca da Meia-Noite">
                        <div class="card-body">
                            <h5 class="card-title">A Biblioteca da Meia-Noite</h5>
                            <p class="card-text fs-sm text-muted mb-1">Autor(a): Matt Haig</p>
                            <p class="card-text fs-sm text-muted">Editor(a): TopSeller</p>
