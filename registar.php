    ...
    <div class="form-glass-box">
        ...
        <?php if (isset($_GET['erro'])): ?>
            <div class="alert alert-danger text-center py-2 mb-3 shadow-sm border-0">
                ...
                <?php 
                    if ($_GET['erro'] == 'match') echo "As passwords não coincidem.";
                    elseif ($_GET['erro'] == 'exists') echo "Este email já está registado.";
                    else echo "Ocorreu um erro ao criar a conta.";
                ?>
            </div>
        <?php endif; ?>

        <form action="autenticacao/processar_registo.php" method="POST">
