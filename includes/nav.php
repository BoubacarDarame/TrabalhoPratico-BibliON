    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarCustomContent">
            ...
            <form class="d-flex w-100 mx-auto my-3 my-xl-0" role="search" style="max-width: 400px;"
                action="pesquisa.php" method="GET">

                <div class="input-group">
                    <input class="form-control border-end-0" type="search" name="q" 
                        placeholder="Pesquise por título, autor, editora..." aria-label="Pesquisar" required>
            ...
            <ul class="navbar-nav align-items-center">
                ...
                <li class="nav-item mx-2">
                    <a class="nav-link nav-text-link" href="produtos.php">Livros</a>
                </li>
                        ...
                        <li>
                            <?php 
                                ...
                                if (isset($_SESSION['user_role']) && $_SESSION['user_role'] === 'admin') {
                                    $link_perfil = "admin/dashboard.php";
                                }
                            ?>

                            <a class="dropdown-item py-2" href="<?php echo $link_perfil; ?>" class="nav-link">
